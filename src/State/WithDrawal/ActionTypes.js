...
export const WITHDRAWAL_PROCEED_REQUEST = 'WITHDRAWAL_PROCED_REQUEST';
export const WITHDRAWAL_PROCEED_SUCCESS = 'WITHDRAWAL_PROCED_SUCCESS';
export const WITHDRAWAL_PROCEED_FAILURE = 'WITHDRAWAL_PROCED_FAILURE';
