...
import com.CryptoMela.Repository.PaymentOrderRepo;
...
public class PaymentServiceImpl implements PaymentService{
    ...
    public PaymentResponse createRazorpayPaymentLink(User user, Long amount, Long orderId) throws Exception {
        ...
        try{
            ...
            paymentLinkRequest.put("callback_url","http://localhost:7272/wallet?order_id=" + orderId);
    ...
    public PaymentResponse createStripePaymentLink(User user, Long amount, Long orderId) throws StripeException {
        ...
        SessionCreateParams params = SessionCreateParams.builder()
                ...
                .setSuccessUrl("http://localhost:7272/wallet?order_id=" + orderId)
                .setCancelUrl("http://localhost:7272/payment/cancel")
